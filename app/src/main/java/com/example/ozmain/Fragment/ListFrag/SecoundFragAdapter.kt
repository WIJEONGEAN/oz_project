...
class SecoundFragAdapter(val context: Context, val list : ArrayList<ContentListModel>) : BaseAdapter(){
    override fun getView(position: Int, converView: View?, parent: ViewGroup?): View {
        ...
        if ( converView == null) {
            ...
            holder.view_text1 = view.findViewById(R.id.lv_titleview_1)
            holder.view_text2 = view.findViewById(R.id.lv_textview_1)
            holder.view_text3 = view.findViewById(R.id.lv_textview_2)
